...
const App = () => {
  ...
  useEffect(() => {
    /**
     * Fired whenever the SDK closes regardless of user action.
     **/
    ArgyleSdk.onClose(() => {
      console.log('close')
    })
    return () => {
      ArgyleSdk.removeListenerIfAdded('onUserCreated')
      ArgyleSdk.removeListenerIfAdded('onCantFindLinkItemClicked')
      ArgyleSdk.removeListenerIfAdded('onAccountCreated')
      ArgyleSdk.removeListenerIfAdded('onAccountConnected')
      ArgyleSdk.removeListenerIfAdded('onAccountUpdated')
      ArgyleSdk.removeListenerIfAdded('onAccountRemoved')
      ArgyleSdk.removeListenerIfAdded('onAccountError')
      ArgyleSdk.removeListenerIfAdded('onError')
      ArgyleSdk.removeListenerIfAdded('onClose')
    }
  }, [ArgyleSdk])
